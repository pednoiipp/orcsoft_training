...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements th.co.orcsoft.services.HelloWorldService {
    ...
    private java.lang.String HelloWorldPort_address = "http://localhost:8080/HelloServices/HelloWorld";
    ...
    public th.co.orcsoft.services.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            th.co.orcsoft.services.HelloWorldServiceSoapBindingStub _stub = new th.co.orcsoft.services.HelloWorldServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (th.co.orcsoft.services.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                th.co.orcsoft.services.HelloWorldServiceSoapBindingStub _stub = new th.co.orcsoft.services.HelloWorldServiceSoapBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.orcsoft.co.th/", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.orcsoft.co.th/", "HelloWorldPort"));
        }
